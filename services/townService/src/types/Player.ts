...
import { JoinRequest, ServerConversationArea } from '../client/TownsServiceClient';
import { UserLocation } from '../CoveyTypes';

/**
 * Defines what permissions a player has
 */
...
export default class Player {
  ...
  private _activeJoinRequest?: JoinRequest;

  private _permissions: PlayerPermissions;
  ...
  constructor(userName: string) {
    ...
    this._id = nanoid();
    this._permissions = PlayerPermissions.Normal;
  }
  ...
  get permissions(): PlayerPermissions {
    return this._permissions;
  }

  set permissions(permissionLevel: PlayerPermissions) {
    this._permissions = permissionLevel;
  }
  ...
  get activeJoinRequest(): JoinRequest | undefined {
    return this._activeJoinRequest;
  }

  set activeJoinRequest(joinRequest: JoinRequest | undefined) {
    this._activeJoinRequest = joinRequest;
  }
