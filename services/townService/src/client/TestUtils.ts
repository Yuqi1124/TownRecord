...
import { BoundingBox, ConversationAreaStatus, ServerConversationArea } from './TownsServiceClient';
...
export function createConversationForTesting(params?: {
  ...
  return {
    ...
    status: params?.status !== undefined ? params?.status : ConversationAreaStatus.Public,
