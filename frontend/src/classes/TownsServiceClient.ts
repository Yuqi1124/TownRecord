...
import { JoinRequest, ServerConversationArea } from './ConversationArea';
...
export default class TownsServiceClient {
  ...
  async updateConversation(requestData: ConversationUpdateRequest) : Promise<void>{
    const responseWrapper = await this._axios.patch(`/towns/${requestData.coveyTownID}/conversationAreas/${requestData.conversationArea.label}`, requestData);
    return TownsServiceClient.unwrapOrThrowError(responseWrapper);
  }

  async createJoinRequest(requestData: JoinRequestCreateRequest) : Promise<void>{
